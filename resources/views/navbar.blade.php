...
<body>
 ...
 <!--      <h1 class="logo mr-auto"><a href="index.html">Mentor</a></h1> -->
      <!-- Uncomment below if you prefer to use an image logo -->
       <a href="/" class="logo mr-auto"><img src="../user/assets/img/logotulis.png" alt="" class="img-fluid"></a>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <ul>
              ...
              <li><a href="/pengawas">Pengawas</a></li>
            </ul>
          </li>
          ...
          <ul>
              ...
              <li><a href="/fotobangunan">Foto Bangunan</a></li>
            </ul>
          </li>
          <li><a href="/karir">Karir</a></li>
          <li class="drop-down"><a href="#">Unit</a>
            <ul>
              <li><a href="/unitpendidikan">Unit Pendidikan</a></li>
              <li><a href="/unitkesejahteraan">Unit Kesejahteraan</a></li>
              <li><a href="/unitbisnis">Unit Bisnis</a></li>
            </ul>
          </li>
        </ul>
      </nav><!-- .nav-menu -->
