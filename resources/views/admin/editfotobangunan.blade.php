  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Foto Bangunan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/home">Home</a></li>
              <li class="breadcrumb-item active">Edit Fotobangunan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <form method="post" action="/updatefotobangunan" enctype="multipart/form-data">
                  {{ csrf_field() }}
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">List Foto Bangunan</h3>
                ...
                @php $no = 1; @endphp
                  ...
                  <tr>
                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                   @php
                                $path = Storage::url('public/fotobangunan/'.$data->foto);
                                @endphp 
                      ...
                      <td class="project-actions text-right">
                          ...
                          <a type="button" class="btn btn-danger"  href="/deletefotobangunan/{{$data->id}}">
                      ...
                      <div class="modal-content">
                        <!-- Modal Header -->
                          <div class="modal-header">
                              <h4 class="modal-title" id="myModalLabel">View Foto Bangunan</h4>
...
<div class="modal fade" id="modalfade1-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" width="100%">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <!-- Modal Header -->
            <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Edit Bangunan</h4>
            </div>
            <div class="modal-body">
                  <section class="content">
      <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <div class="form-group">
                  <form action="/updatefotobangunan" method="post">
                    @csrf
