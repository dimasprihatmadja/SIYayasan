  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Pendiri</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
                  <form method="post" action="/updatependiri" enctype="multipart/form-data">
                  {{ csrf_field() }}
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">List Pendiri</h3>
                ...
                @php $no = 1; @endphp
                  ...
                  <tr>
                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                @php
                                $path = Storage::url('public/pendiri/'.$data->foto);
                                @endphp 
                      ...
                      <td class="project-actions text-right">
                          ...
                          <a type="button" class="btn btn-danger"  href="/deletependiri/{{$data->id}}">
...
<div class="modal fade" id="modalfade1-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" width="100%">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <!-- Modal Header -->
            <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Edit Pendiri</h4>
            </div>
            <div class="modal-body">
                  <section class="content">
      <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <div class="form-group">
                  <form action="/updatependiri" method="post">
