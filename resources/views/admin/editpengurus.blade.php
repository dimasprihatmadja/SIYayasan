  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form method="post" action="/updatepengurus" enctype="multipart/form-data">
                  {{ csrf_field() }}
                 ...
                 @php $no = 1; @endphp
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          ...
                          <a type="button" class="btn btn-danger"  href="/deletepengurus/{{$data->id}}">
                      ...
                      <div class="modal-content">
                        <!-- Modal Header -->
                          <div class="modal-header">
                              <h4 class="modal-title" id="myModalLabel">View Pengurus</h4>
